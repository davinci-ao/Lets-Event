				...
				<div class="card-body">
					...
					<form action="{{ route('event.update', $event->id)}}" enctype="multipart/form-data" method="POST">
						...
						<div class="custom-file" id="inputGroupFile01div" style="padding-bottom: 55px">
							...
							<img id="inputGroupFile01PR" src="{{asset($event->indexpicture)}}" alt="" width="320" height="200" />
						</div>	
						...
						<div class="custom-file"  id="inputGroupFile02div" style="padding-bottom: 55px">
							...
							<img id="inputGroupFile02PR" src="{{asset($event->viewpicture)}}" alt="" width="200" height="200" />
						</div>	
...
<script type="text/javascript">
	$(document).ready(function () {
		var image01 = $('#inputGroupFile01PR').attr('src');
		var image02 = $('#inputGroupFile02PR').attr('src');
		
		if (image01 !== "" && image01 !== "http://letsevent.local/") {
			$('#inputGroupFile01div').css({'padding-bottom': '250px'});
		}
		if (image02 !== "" && image02 !== "http://letsevent.local/") {
			console.log('test');
